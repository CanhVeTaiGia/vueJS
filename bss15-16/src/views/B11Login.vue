<template>
    <v-form class="border rounded w-96 m-2 p-3">
      ...
      <v-text-field
        ...
        variant="outlined"
      ></v-text-field>
      <v-btn width="100%" color="blue">Đắng nhập</v-btn>
      <span class="p-4 flex gap-1 justify-center">
        <p class="font-thin">Chưa có tài khoản</p>
        <RouterLink to="/B11Register" class="cursor-pointer font-bold">Đăng kí</RouterLink>
      </span>
    </v-form>
  </template>
  <script setup></script>
